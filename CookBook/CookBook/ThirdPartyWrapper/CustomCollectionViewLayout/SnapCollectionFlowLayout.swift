...
class SnapCollectionFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        guard let unwrappedCollectionView = collectionView else { return }
    ...
    override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        guard let unwrappedCollectionView = collectionView else { return CGPoint(x: 0, y: 0) }
    ...
    private func recalculateItemSize(for itemHeight: CGFloat) {
        ...
        let horizontalContentInset =
            unwrappedCollectionView.contentInset.left + unwrappedCollectionView.contentInset.right

        let verticalContentInset =
            unwrappedCollectionView.contentInset.bottom + unwrappedCollectionView.contentInset.top
        
        let divider: CGFloat = 1.0
        ...
        itemSize = CGSize(
            width: unwrappedCollectionView.bounds.width / divider - horizontalContentInset,
            height: itemHeight - verticalContentInset
        )
